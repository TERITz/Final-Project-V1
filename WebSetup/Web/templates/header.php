        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-8">
                <a href="/" class="flex items-center space-x-2 group">
                    ...
                    <span class="text-white font-bold text-xl tracking-wide">EVENTKUB</span>
                </a>
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="/owner_events" class="text-gray-300 hover:text-white px-4 py-2 rounded-md text-sm font-medium transition hover:bg-slate-800">
                        จัดการกิจกรรม
                    </a>
